...
public class ElementBasicActions {
    ...
    public static void main(String[] args) throws Exception {
        ...
        WebElement textElement= driver.findElement(AppiumBy.accessibilityId("Text"));

        By views = AppiumBy.accessibilityId("Views");
        By textFields = AppiumBy.accessibilityId("TextFields");
        By editText = AppiumBy.id("io.appium.android.apis:id/edit");
/*
        By textElement2=AppiumBy.accessibilityId("Text");
...
*/
        ...
        driver.findElement(editText).sendKeys("Hello Friend");
        Thread.sleep(3000);
